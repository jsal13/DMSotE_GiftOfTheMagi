...
- **QUESTION?** I'm not sure how to read 04, 05, 09** together.  I think this means we have to go to Adress 00000400 to see the end of the PRG, since it's 16KiB * 8 = 128KiB = 131,072 bytes.

  
- Note the address \$06 above.  Check this flag out here[here](https://www.nesdev.org/wiki/NES_2.0#File_Structure), which we reproduce below for convenience.  The binary is $00010010$ which gives us: "Mapper Number D0" (**QUESTION: WHAT IS THIS**) and "Battery" present.  Indeed, there was a battery with this game.
...
```
<prgrom size="131072" crc32="4EBDB122" sha1="04EA802E3E41584ED1177482FD9E9D7560EB5BD2" sum16="E2B2" />
<chrrom size="131072" crc32="D0F69B41" sha1="B55180760FC4D1F29977CAA5F2897DD497C0E2D3" sum16="EC5C" />
<rom size="262144" crc32="23C3FB2D" sha1="46CC4F6A0271828567419602CE19AB87F46062A5" />
<prgnvram size="8192" />
<pcb mapper="1" submapper="0" mirroring="H" battery="1" />
