...
- **QUESTION?** I'm not sure how to read 04, 05, 09** together.  I think it's something like: there's \$0x0008 and \$0x0010 KiBs for PRG and CHR respectively, but I'm not sure.  That doesn't quite make sense.  Even assuming it's 16 times that number, it's pretty low but that might be it.
